...
axios.interceptors.response.use((response) => {
	...
	if(datas.fullPath.indexOf("guide") != -1 || datas.fullPath.indexOf("register") != -1 || datas.fullPath.indexOf("bannerfr") != -1 || datas.fullPath.indexOf("result") != -1 || datas.fullPath.indexOf("download") != -1 || datas.fullPath.indexOf("bannerse") != -1 || datas.fullPath.indexOf("download") != -1 || datas.fullPath.indexOf("market") != -1 || datas.fullPath.indexOf("agreement") != -1 ){
		//getinfo(datas)
	}
	return response
}, function (error) {
...
router.beforeEach((to, from, next) => {
    ...
    document.documentElement.scrollTop ? document.documentElement.scrollTop = 0 : document.body.scrollTop = 0;
		...
		// getinfo(datas);
		//若没有登录信息 则返回登录页面
		if(to.fullPath.indexOf("guide") != -1 || to.fullPath.indexOf("register") != -1 || to.fullPath.indexOf("bannerfr") != -1 || to.fullPath.indexOf("result") != -1 || to.fullPath.indexOf("download") != -1 || to.fullPath.indexOf("bannerse") != -1 || to.fullPath.indexOf("download") != -1 || to.fullPath.indexOf("market") != -1 || to.fullPath.indexOf("agreement") != -1 ){
			next();
		}else{
